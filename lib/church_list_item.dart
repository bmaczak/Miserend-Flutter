    ...
    return Center(
      child: Card(
        ...
        child: InkWell(
          ...
          onTap: () {
            _openDetails(widget.churchWithMasses.church, context);
          },
          child: SizedBox(
              height: 176,
              child: Row(
                  ...
                  children: [
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.fromLTRB(
                                    8.0, 8.0, 8.0, 4.0),
                                child: Text(widget.churchWithMasses.church.name ?? "",
                                    style:
                                    Theme
                                        .of(context)
                                        .textTheme
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsets.fromLTRB(
                                      8.0, 0.0, 8.0, 8.0),
                                  child: Text(widget.churchWithMasses.church.commonName ?? "",
                                      style: Theme
                                          .of(context)
                                          .textTheme
                                          .subtitle2),
                              ...
                              Text(widget.churchWithMasses.masses.length.toString(),
                                  style: Theme
                                      .of(context)
                                      .textTheme
                                      .subtitle2),
                                ...
                                builder: (context, favoritesService, child) {
                                  return IconButton(
                                    icon: favoritesService
                                        .isFavorite(widget.churchWithMasses.church.id)
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        _toggleFavorites(widget.churchWithMasses.church.id);
                                      });
                                    },
                                  );
                                },
                    ...
                    Expanded(
                      flex: 1,
                      child: widget.churchWithMasses.church.imageUrl?.isNotEmpty ?? false
                          ? FadeInImage.assetNetwork(
                        image: widget.churchWithMasses.church.imageUrl ?? "",
                        fit: BoxFit.cover,
